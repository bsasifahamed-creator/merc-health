  ...
  return (
    <section id="different" className="bg-slate overflow-hidden">
      ...
      <div className="relative overflow-hidden py-4 sm:py-6">
        ...
        {/* Left button — hidden on mobile (swipe works natively) */}
        <button onClick={goLeft} className="hidden sm:flex absolute left-4 top-1/2 -translate-y-1/2 z-20 w-12 h-12 rounded-full border border-border-custom bg-card/80 backdrop-blur-sm text-platinum hover:border-gold hover:text-gold transition-colors items-center justify-center cursor-pointer" aria-label="Previous">
          <ArrowLeft className="h-5 w-5" />
        </button>
        {/* Right button — hidden on mobile (swipe works natively) */}
        <button onClick={goRight} className="hidden sm:flex absolute right-4 top-1/2 -translate-y-1/2 z-20 w-12 h-12 rounded-full border border-border-custom bg-card/80 backdrop-blur-sm text-platinum hover:border-gold hover:text-gold transition-colors items-center justify-center cursor-pointer" aria-label="Next">
